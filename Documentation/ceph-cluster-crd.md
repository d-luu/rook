...
- `priorityClassNames`: [priority_class_names_configuration_settings](#priority-class-names-configuration-settings)
...
### PriorityClassNames Configuration Settings
Priority class names can be specified so that the Rook components will have those priority class names added to them.

You can set priority class names for Rook components through the a list of key value pairs:

- `all`: Set priority class names for all components.
